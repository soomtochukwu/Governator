  ...
  return (
    <div className="flex justify-between gap-6 mt-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            <input
              ...
              className="w-1/2 px-4 py-3 bg-[#010014] text-white border border-[#00ff85] rounded-md focus:outline-none"
            />
            <select className="w-1/2 px-4 py-3 bg-[#010014] text-white border border-[#00ff85] rounded-md focus:outline-none">
          ...
          <div className="flex items-center gap-4">
            ...
            <input type="radio" name="voteType" className="text-[#00ff85]" />
      ...
      <section className="w-1/3 bg-[#1a1a2e] p-6 rounded-lg border border-[#00ff85]">
        <h2 className="text-lg font-semibold text-[#00ff85] mb-4">
